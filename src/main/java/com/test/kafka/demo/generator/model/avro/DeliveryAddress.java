...
public class DeliveryAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8097556299589946932L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DeliveryAddress\",\"namespace\":\"com.test.kafka.demo.generator.model.avro\",\"fields\":[{\"name\":\"addressline\",\"type\":\"string\"},{\"name\":\"city\",\"type\":\"string\"},{\"name\":\"state\",\"type\":\"string\"},{\"name\":\"pinCode\",\"type\":\"string\"},{\"name\":\"contactNumber\",\"type\":\"string\"}]}");
   ...
   */
  public static com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder newBuilder() {
    return new com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder();
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder newBuilder(com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder other) {
    if (other == null) {
      return new com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder();
    } else {
      return new com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder(other);
    }
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder newBuilder(com.test.kafka.demo.generator.model.avro.DeliveryAddress other) {
    if (other == null) {
      return new com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder();
    } else {
      return new com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeliveryAddress>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.test.kafka.demo.generator.model.avro.DeliveryAddress other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.addressline)) {
        this.addressline = data().deepCopy(fields()[0].schema(), other.addressline);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder setAddressline(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder clearAddressline() {
      addressline = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder setPinCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder clearPinCode() {
      pinCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder setContactNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.test.kafka.demo.generator.model.avro.DeliveryAddress.Builder clearContactNumber() {
      contactNumber = null;
